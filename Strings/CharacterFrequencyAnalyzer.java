...
class HashmapCharacterFrequencyAnalyzer {
    public static void HashmapCharacterFrequencyAnalyzerMethods(String str) {
        ...
        ArrayList<Character> mapkeyset = new ArrayList<>(map.keySet());
        for (int i = 0; i < mapkeyset.size(); i++) {
            System.out.println(mapkeyset.get(i) + " = " + map.get(mapkeyset.get(i)));
        }
    }
}
